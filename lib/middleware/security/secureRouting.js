...
var checkUserExists = function (user) { return __awaiter(void 0, void 0, void 0, function () {
    var response;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, index_js_1.db_adm_conn.query("\n    SELECT COUNT enduserid FROM enduser WHERE enduserid = '".concat((0, scripts_js_1.checkInputBeforeSqlQuery)(user.userid)))];
            case 1:
                response = _a.sent();
...
var secureRouteMiddleware = function (req, res, next) {
    ...
    if (typeof token != "undefined" && token != null) {
        try {
            ...
            req.user = user;
            if (!(0, exports.checkUserExists)(user))
        ...
        try {
            ...
            var user = jsonwebtoken_1.default.verify(header_token, process.env.JWT_SECRET);
            req.user = user;
            if (!(0, exports.checkUserExists)(user))
                throw "user does not exist";
            next();
