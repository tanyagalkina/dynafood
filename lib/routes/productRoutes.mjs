...
var barcode_scanner_js_1 = require("../modules/barcode_scanner.js");
 ...
 */
router.get('/products/barcode/:barcode', secureRouting_js_1.secureRouteMiddleware, barcode_scanner_js_1.getProduct);
